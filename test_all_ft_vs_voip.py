...
def main():
    ...
    print("Extracting features for ALL FT vs ALL VOIP...")
    ...
    print(f"\nOriginal counts -> ALL FT: {len(X_ft)}, ALL VOIP: {len(X_voip)}")
    ...
    print(f"Balanced counts -> ALL FT: {len(X_ft_b)}, ALL VOIP: {len(X_voip_b)}")
    
    X = np.vstack([X_ft_b, X_voip_b])
    # Label 1 = FT, Label 0 = VOIP
    ...
    # Using only the first feature (flips)
    ...
    print(f"                 Predicted VOIP          Predicted FT")
    print(f"Actual VOIP            {cm_a[0, 0]:<20}    {cm_a[0, 1]:<18}")
    print(f"Actual FT              {cm_a[1, 0]:<20}    {cm_a[1, 1]:<18}")
    ...
    print(f"                 Predicted VOIP          Predicted FT")
    print(f"Actual VOIP            {cm_b[0, 0]:<20}    {cm_b[0, 1]:<18}")
    print(f"Actual FT              {cm_b[1, 0]:<20}    {cm_b[1, 1]:<18}")
