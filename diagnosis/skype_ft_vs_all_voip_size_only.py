...
def extract_size_features(temp_tensor):
    features = []
...
def test_skype_ft_vs_all_voip_size_only():
    data_dir = 'data/processed'
    X, y = [], []
    
    print("Extracting ONLY Size features for Skype FT vs ALL VOIP...")
    ...
    for f in os.listdir(data_dir):
        ...
        feats = extract_size_features(data['temporal'])
        X.append(feats)
    ...
    print("\nTraining Random Forest Classifier on ONLY Size features...")
...
if __name__ == "__main__":
    test_skype_ft_vs_all_voip_size_only()
